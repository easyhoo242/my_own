  ...
  <section class="af-wrap">
    <template v-if="isInit">
      ...
      <div class="af-body">
        ...
        >
          <div class="af-body__search d-flex justify-content-between align-items-baseline">
            <div class="af-body__search--tip flex-0">
              关键词:
            </div>
            <el-input
              v-model="keyword"
              ...
              class="af-body__search--input flex-0"
            />
            <div class="af-body__search--text flex-fill">
              各类统计图表+数据下载功能正在研发中 敬请期待
            </div>
          </div>
...
const useScreen = () => {
  ...
  if (process.client) {
    ...
    getCompanyRoundOption().then((res) => {
      console.log(res)
      roundOptions.value = [
        {
          key: ALL_KEY,
...
export default defineComponent({
  ...
  setup() {
    ...
    const fetchVals = computed(() => ({
      ...
      status: statusVal.value === ALL_KEY ? undefined : statusVal.value,
                ...
                h('div', { class: 'af-com-tip' }, [
                  ...
                  Math.random() * 10 > 5
                    ? h(
                        ...
                        {
                          style:
                            'color: red; margin-left: 5px; font-weight: 500;'
                        },
                        '已关闭'
                      )
                    : null
